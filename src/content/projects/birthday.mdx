...
I originally created *[Birthday Website Generator!](https://commandergl.github.io/birthday/)* for my Mom's birthday. I had decided to try out a new framework *[(Vue)](https://vuejs.org/)* with this new project. I slowly fell in love with *Vue* and all of it's features. The *Vue* Community also seemed to be very quite nice. My love of *Vue* quickly led me to start a new project [(OpenYT)](https://github.com/OpenSourceYT/OpenYT) with it.
